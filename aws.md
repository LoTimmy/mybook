...
> `Amazon EC2`是一種可用來在雲端建立和執行虛擬機器的`Amazon Web Service`(我們稱這些虛擬機器為「執行個體」)
> `Amazon Machine Image` (`AMI`)，`AMI`是包含軟體設定的範本 (例如，作業系統、應用程式伺服器和應用程式)。

`亞馬遜雲端服務`（`AWS`, `Amazon Web Services`）
`虛擬私人雲`（`virtual private cloud`，簡稱`VPC`）

`计算`
<img src="https://d3rrzw75sdtfe5.cloudfront.net/_compute-ca96ab4621b0842d18e4e2f93474d7396e51ccf3.svg" alt="" width=22 height=22> `EC2`

`存储`
<img src="https://d3rrzw75sdtfe5.cloudfront.net/_storage-3ac83fc69e486c07af51ccc12cf910d387e56c9a.svg" alt="" width=22 height=22> `S3`

`数据库`
<img src="https://d3rrzw75sdtfe5.cloudfront.net/_database-35400ce5e06d23e49a64646db72d29506d703ec6.svg" alt="" width=22 height=22> 

`网络和内容分发`
<img src="https://d3rrzw75sdtfe5.cloudfront.net/_networking-124a314d0b15c71bbe9a9cfa2b6b45d2016943c5.svg" alt="" width=22 height=22>
`VPC`
`CloudFront`
`Route 53`
...
<img src="https://d1gmaa4bv8uttx.cloudfront.net/07b61510088d1896ddeda2b8d9159a27a7e4961d/ec2/clear.cache.gif" style="width:20px;height:20px;background:url(data:image/png;base64,) no-repeat 0px 0px;" border="0">

<img src="https://d1gmaa4bv8uttx.cloudfront.net/07b61510088d1896ddeda2b8d9159a27a7e4961d/ec2/clear.cache.gif" style="width:20px;height:20px;background:url(data:image/png;base64,) no-repeat 0px 0px;" border="0">

<img src="https://d1gmaa4bv8uttx.cloudfront.net/07b61510088d1896ddeda2b8d9159a27a7e4961d/ec2/clear.cache.gif" style="width:20px;height:20px;background:url(data:image/png;base64,) no-repeat 0px 0px;" border="0">


<img src="https://d1gmaa4bv8uttx.cloudfront.net/07b61510088d1896ddeda2b8d9159a27a7e4961d/ec2/clear.cache.gif" style="width:20px;height:18px;background:url(data:image/png;base64,) no-repeat 0px 0px;" border="0">

<img src="https://d1gmaa4bv8uttx.cloudfront.net/07b61510088d1896ddeda2b8d9159a27a7e4961d/ec2/clear.cache.gif" style="width:21px;height:20px;background:url(data:image/gif;base64,) no-repeat 0px 0px;" border="0">

<img src="https://d1gmaa4bv8uttx.cloudfront.net/07b61510088d1896ddeda2b8d9159a27a7e4961d/ec2/clear.cache.gif" style="width:17px;height:21px;background:url(data:image/gif;base64,) no-repeat 0px 0px;" border="0">
